...
m_03 = User.create(name: "Fresh Start Produce Too", address: "3225 Denargo St" , city: "Denver", state: "CO", zip: "80216", email: "freshstart@freshstartproducetoo.com", password: "bountiful", role: 1, created_at: 31.days.ago)
...
it_01 = m_01.items.create(name: "Apple", image: "https://images.unsplash.com/photo-1478004521390-655bd10c9f43?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80", description: "Gala Apple, One Medium. Organic, natural, can be stored in refrigerators.", inventory: 15, price: 0.50, active: true)
it_02 = m_01.items.create(name: "Avocado", image: "https://images.unsplash.com/photo-1512070904629-fa988dab2fe1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80", description: "Hass Avocado, One Large. Grown in Mexico or California.", inventory: 7, price: 1.42, active: true)
it_03 = m_02.items.create(name: "Bananas", image: "https://images.unsplash.com/reserve/RNm0KceQ4Gbpb0xldOe7_DSC_0679_2.JPG?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1602&q=80", description: "One bunch contains approximately 5-7 bananas. Grown in Ecuador or Costa Rica or Guatemala.", inventory: 21, price: 1.79, active: true)
it_04 = m_02.items.create(name: "Blackberries", image: "https://images.unsplash.com/photo-1474480109237-15a7ca8f0685?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1653&q=80", description: "Blackberries, 6 oz. Grown in United States, Chile, or Mexico.", inventory: 14, price: 2.99, active: true)
it_05 = m_03.items.create(name: "Blueberries", image: "https://images.unsplash.com/photo-1498557850523-fd3d118b962e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80", description: "Organic Blueberries, 6 oz. Grown in United States, Mexico, Peru, Chile, Argentina and Canada.", inventory: 12, price: 3.99, active: true)
it_06 = m_03.items.create(name: "Brussel Sprouts", image: "https://images.unsplash.com/photo-1438118907704-7718ee9a191a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80", description: "Brussels Sprouts, 12 oz Bag. Pre-washed.", inventory: 21, price: 2.99, active: true)
it_07 = m_03.items.create(name: "Carrots", image: "https://images.unsplash.com/photo-1445282768818-728615cc910a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80", description: "Organic Carrots, 1 lb. Grown in United States or Mexico.", inventory: 28, price: 0.99, active: true)
it_08 = m_04.items.create(name: "Garlic", image: "https://images.unsplash.com/photo-1441861539200-6208cf4a122f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1100&q=80", description: "Organic Garlic, One Medium. Grown in United State, Argentina, Mexico, Spain, or China.", inventory: 42, price: 1.99, active: true)
it_09 = m_04.items.create(name: "Kale", image: "https://images.unsplash.com/photo-1524179091875-bf99a9a6af57?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80", description: "Organic Kale, One Bunch. Grown in United States or Mexico.", inventory: 17, price: 2.99, active: true)
it_10 = m_05.items.create(name: "Orange", image: "https://images.unsplash.com/photo-1482012792084-a0c3725f289f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80", description: "Navel Orange, One Medium. Grown in United States. Easy to peel.", inventory: 22, price: 0.79, active: true)
it_11 = m_05.items.create(name: "Pineapple", image: "https://images.unsplash.com/photo-1439478580632-ca2f5e3767af?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80", description: "Gold Pineapple, One Medium. Organic, natural, can be stored in refrigerators.", inventory: 11, price: 2.50, active: true)
it_12 = m_06.items.create(name: "Pomegranate", image: "https://images.unsplash.com/photo-1507654304600-18d902b183b4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=939&q=80", description: "Pomegranate, One Medium. Grown in northern India.", inventory: 4, price: 2.99, active: true)
it_13 = m_07.items.create(name: "Spinach", image: "https://images.unsplash.com/photo-1515363578674-99f41329ab4c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1647&q=80", description: "Organic Baby Spinach, 16 oz. Triple-washed.", inventory: 19, price: 4.99, active: true)
it_14 = m_07.items.create(name: "Tomato", image: "https://images.unsplash.com/photo-1494220394759-e0b232f883ef?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80", description: "Organic Tomatoes, 1.5 lb. Grown in United States or Mexico.", inventory: 24, price: 3.99, active: true)
it_15 = m_08.items.create(name: "Yellow Bell Pepper", image:"https://images.unsplash.com/photo-1551280601-3b3715db4e77?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1567&q=80", description: "Organic Yellow Bell Pepper, One Medium.", inventory: 31, price: 2.29, active: true)

o_01 = u_01.orders.create(status: 1, created_at: 10.days.ago, updated_at: 5.days.ago)
...
o_02 = u_02.orders.create(status: 0, created_at: 5.days.ago, updated_at: 2.days.ago)
...
o_05 = u_05.orders.create(status: 1, created_at: 9.days.ago, updated_at: 3.days.ago)
...
o_06 = u_06.orders.create(status: 0, created_at: 12.days.ago, updated_at: 11.days.ago)
...
o_09 = u_09.orders.create(status: 1, created_at: 1.day.ago, updated_at: 1.day.ago)
...
o_10 = u_10.orders.create(status: 0, created_at: 3.days.ago, updated_at: 1.day.ago)
