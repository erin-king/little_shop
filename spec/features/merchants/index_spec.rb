...
RSpec.describe "merchant index workflow", type: :feature do
  describe "As a visitor" do
    ...
    describe "shows merchant statistics" do
      ...
      it "top 10 merchants by items, for this month and last month" do
        ...
        within("#top-ten-merchants-by-items-this-month") do
          expect(page).to have_content("#{@m13.name}")
          expect(page).to have_content("#{@m12.name}")
          expect(page).to have_content("#{@m11.name}")
        end

        within("#top-ten-merchants-by-items-last-month") do
          expect(page).to have_content("#{@m7.name}")
